...
def rf_data_recorder(rx_args, txs_args, general_config, rx_data_nbytes_que):
    ...
    for i in range(rx_args.nrecords):
        ...
        # NEED TO ADD THE TIME BETWEEN DONE MANUALLY FOR NOW
        print(rx_args.time_between)
        print("Change time between in /src/lib/run_rf_data_recorder.py line 120, currently set to 1")
        time.sleep(1)
